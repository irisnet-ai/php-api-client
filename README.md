...
*AICheckOperationsApi* | [**checkPoaDocument**](docs/Api/AICheckOperationsApi.md#checkpoadocument) | **POST** /v2/check-poa-document/{configId} | Perform a proof of address check with the AI.
...
- [AgeAttribute](docs/Model/AgeAttribute.md)
