...
class MiscellaneousOperationsApi
{
     ...
     */
    public function downloadProcessedRequest($filename)
    {
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Irisnet\API\Client\Model\INError|int
     */
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Irisnet\API\Client\Model\INError|int, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAICostRequest()
    {
     ...
     *
     * @param  string $licenseKey License obtained from the https://irisnet.de/subscribe shop. (required)
     *
     * @throws \Irisnet\API\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getLicenseInfoWithHttpInfo($licenseKey);
        return $response;
    }
    ...
    {
        $request = $this->getLicenseInfoRequest($licenseKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLicenseInfoAsync($licenseKey)
    {
        return $this->getLicenseInfoAsyncWithHttpInfo($licenseKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLicenseInfoAsyncWithHttpInfo($licenseKey)
    {
        $returnType = '\Irisnet\API\Client\Model\LicenseInfo';
        $request = $this->getLicenseInfoRequest($licenseKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLicenseInfoRequest($licenseKey)
    {
        // verify the required parameter 'licenseKey' is set
        if ($licenseKey === null || (is_array($licenseKey) && count($licenseKey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $licenseKey when calling getLicenseInfo'
            );
        }
