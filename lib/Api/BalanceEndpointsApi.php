...
/**
    ...
    {
        list($response) = $this->getCostWithHttpInfo($configId, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCostRequest($configId, $contentType);
        ...
        try {
            ...
            $returnType = '\Irisnet\API\Client\Model\Pricing';
     ...
     */
    public function getCostAsync($configId, string $contentType = self::contentTypes['getCost'][0])
    {
        return $this->getCostAsyncWithHttpInfo($configId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCostAsyncWithHttpInfo($configId, string $contentType = self::contentTypes['getCost'][0])
    {
        $returnType = '\Irisnet\API\Client\Model\Pricing';
        $request = $this->getCostRequest($configId, $contentType);
     ...
     */
    public function getCostRequest($configId, string $contentType = self::contentTypes['getCost'][0])
    {

        // verify the required parameter 'configId' is set
        if ($configId === null || (is_array($configId) && count($configId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $configId when calling getCost'
            );
        }
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Irisnet\API\Client\Model\ApiNotice|\Irisnet\API\Client\Model\LicenseInfo
     */
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Irisnet\API\Client\Model\ApiNotice|\Irisnet\API\Client\Model\LicenseInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLicenseInfoWithHttpInfo(string $contentType = self::contentTypes['getLicenseInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Irisnet\API\Client\Model\LicenseInfo' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Irisnet\API\Client\Model\LicenseInfo' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            $returnType = '\Irisnet\API\Client\Model\LicenseInfo';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    {
        list($response) = $this->getVideoCostWithHttpInfo($configId, $frames, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getVideoCostRequest($configId, $frames, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVideoCostAsync($configId, $frames, string $contentType = self::contentTypes['getVideoCost'][0])
    {
        return $this->getVideoCostAsyncWithHttpInfo($configId, $frames, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVideoCostAsyncWithHttpInfo($configId, $frames, string $contentType = self::contentTypes['getVideoCost'][0])
    {
        $returnType = '\Irisnet\API\Client\Model\Pricing';
        $request = $this->getVideoCostRequest($configId, $frames, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVideoCostRequest($configId, $frames, string $contentType = self::contentTypes['getVideoCost'][0])
    {

        // verify the required parameter 'configId' is set
        if ($configId === null || (is_array($configId) && count($configId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $configId when calling getVideoCost'
            );
        }
    ...
    {
        list($response) = $this->getVideoCost1WithHttpInfo($configId, $fps, $duration, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getVideoCost1Request($configId, $fps, $duration, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVideoCost1Async($configId, $fps, $duration, string $contentType = self::contentTypes['getVideoCost1'][0])
    {
        return $this->getVideoCost1AsyncWithHttpInfo($configId, $fps, $duration, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVideoCost1AsyncWithHttpInfo($configId, $fps, $duration, string $contentType = self::contentTypes['getVideoCost1'][0])
    {
        $returnType = '\Irisnet\API\Client\Model\Pricing';
        $request = $this->getVideoCost1Request($configId, $fps, $duration, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVideoCost1Request($configId, $fps, $duration, string $contentType = self::contentTypes['getVideoCost1'][0])
    {

        // verify the required parameter 'configId' is set
        if ($configId === null || (is_array($configId) && count($configId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $configId when calling getVideoCost1'
            );
        }
