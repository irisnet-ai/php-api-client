...
class AICheckOperationsApi
{
     ...
     *
     * @param  string $configId The configuration id from the Basic Configuration operations. (required)
     * @param  string $url &lt;s&gt;The url to the image that needs to be checked.&lt;/s&gt; Deprecated: Use request body instead. &lt;b&gt;This parameter will be removed in future releases.&lt;/b&gt; (optional) (deprecated)
     ...
     * @param  \Irisnet\API\Client\Model\Data $data The http(s) url or base64 encoded body uri of the image that needs to be checked. (optional)
     ...
     * @param  bool $imageEncode Specifies whether or not to draw an output video that can be downloaded afterwards. The output video format will be MP4 containing H.264 encoding independent of the input format. The _Encoded_ schema will be available in the response. (optional, default to false)
     * @param  int $checkRate The milliseconds between each AI check. E.g. The AI will check 1 frame per second when checkRate is set to &#39;1000&#39;. (optional, default to 0)
