...
class AICheckOperationsApi
{
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Irisnet\API\Client\Model\ApiNotice|\Irisnet\API\Client\Model\LiveDocumentCheckResponseData
     */
     ...
     * @throws \Irisnet\API\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Irisnet\API\Client\Model\ApiNotice|\Irisnet\API\Client\Model\LiveDocumentCheckResponseData, HTTP status code, HTTP response headers (array of strings)
     */
    public function liveDocumentCheckWithHttpInfo($configId, $liveDocumentCheckRequestData, string $contentType = self::contentTypes['liveDocumentCheck'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 202:
                    if ('\Irisnet\API\Client\Model\LiveDocumentCheckResponseData' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Irisnet\API\Client\Model\LiveDocumentCheckResponseData' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Irisnet\API\Client\Model\LiveDocumentCheckResponseData', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
