...
class LicenseInfo implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['creditsUsed'] = isset($data['creditsUsed']) ? $data['creditsUsed'] : null;
        $this->container['creditsRemaining'] = isset($data['creditsRemaining']) ? $data['creditsRemaining'] : null;
        $this->container['totalCredits'] = isset($data['totalCredits']) ? $data['totalCredits'] : null;
    }
     ...
     * Sets totalCredits
     *
     * @param int|null $totalCredits Total credits contained within the license.
     *
     * @return $this
     */
