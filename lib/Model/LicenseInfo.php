...
class LicenseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['creditsUsed'] = $data['creditsUsed'] ?? null;
        $this->container['creditsRemaining'] = $data['creditsRemaining'] ?? null;
        $this->container['totalCredits'] = $data['totalCredits'] ?? null;
    }
