...
class CheckResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'detections' => '\Irisnet\API\Client\Model\BaseDetection[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('brokenRules', $data ?? [], null);
    ...
    */
     ...
     * Gets summary
     *
     * @return \Irisnet\API\Client\Model\Summary|null
     */
     ...
     * Sets summary
     *
     * @param \Irisnet\API\Client\Model\Summary|null $summary summary
     *
     * @return self
     */
     ...
     * Gets encodings
     *
     * @return \Irisnet\API\Client\Model\Encoded[]|null
     */
     ...
     * Sets encodings
     *
     * @param \Irisnet\API\Client\Model\Encoded[]|null $encodings encodings
     *
     * @return self
     */
     ...
     * Gets brokenRules
     *
     * @return \Irisnet\API\Client\Model\BrokenRule[]|null
     */
    public function getBrokenRules()
    {
        return $this->container['brokenRules'];
    }

    /**
     * Sets brokenRules
     *
     * @param \Irisnet\API\Client\Model\BrokenRule[]|null $brokenRules brokenRules
     *
     * @return self
     */
    public function setBrokenRules($brokenRules)
    {
        if (is_null($brokenRules)) {
            throw new \InvalidArgumentException('non-nullable brokenRules cannot be null');
        }
        $this->container['brokenRules'] = $brokenRules;
     ...
     * Sets detections
     *
     * @param \Irisnet\API\Client\Model\BaseDetection[]|null $detections detections
     *
     * @return self
     */
     ...
     * Gets events
     *
     * @return \Irisnet\API\Client\Model\Event[]|null
     */
     ...
     * Sets events
     *
     * @param \Irisnet\API\Client\Model\Event[]|null $events events
     *
     * @return self
     */
     ...
     * Gets notifications
     *
     * @return \Irisnet\API\Client\Model\ApiNotice[]|null
     */
     ...
     * Sets notifications
     *
     * @param \Irisnet\API\Client\Model\ApiNotice[]|null $notifications notifications
     *
     * @return self
     */
     ...
     * Sets checkId
     *
     * @param string|null $checkId The id of the async running check
     *
     * @return self
     */
