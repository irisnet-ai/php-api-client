 ...
 */
class INObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inGroup'] = $data['inGroup'] ?? null;
        $this->container['inId'] = $data['inId'] ?? null;
        $this->container['color'] = $data['color'] ?? null;
        $this->container['style'] = $data['style'] ?? null;
        $this->container['x0'] = $data['x0'] ?? null;
        $this->container['y0'] = $data['y0'] ?? null;
