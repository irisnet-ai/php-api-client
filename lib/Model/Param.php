...
class Param implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CLASSIFICATION_CELEBRITY = 'celebrity';
    public const CLASSIFICATION_ADVANCED_TEXT_RECOGNITION = 'advancedTextRecognition';
    public const CLASSIFICATION_TEXT = 'text';
