...
class Encoded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The original filename of the image or video.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \SplFileObject|null $data The encoded media in base64 format.
     *
     * @return self
     */
     ...
     * Sets downloadUrl
     *
     * @param string|null $downloadUrl A one time URL to download the resulting media. The URL is only valid for 24 hours.
     *
     * @return self
     */
