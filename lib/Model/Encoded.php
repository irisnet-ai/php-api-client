 ...
 *
 * @category Class
 * @description Contains the resulting media as a data URL (RFC 2397) encoded string or an URL to download that media.
 * @package  Irisnet\API\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Encoded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Contains a randomly generated filename, might be null.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \SplFileObject|null $data The encoded image in data URL format (RFC 2397).
     *
     * @return self
     */
     ...
     * Sets downloadUrl
     *
     * @param string|null $downloadUrl A one time URL to download the resulting video. The URL is only valid for 24 hours.
     *
     * @return self
     */
