...
class IdDocumentSubChecks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'voiceChallengeCheck' => 'string',
        'actionChallengeCheck' => 'string',
        'firstNameConsistency' => 'string',
        'lastNameConsistency' => 'string',
        'dobConsistency' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'voiceChallengeCheck' => null,
        'actionChallengeCheck' => null,
        'firstNameConsistency' => null,
        'lastNameConsistency' => null,
        'dobConsistency' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'voiceChallengeCheck' => false,
        'actionChallengeCheck' => false,
        'firstNameConsistency' => false,
        'lastNameConsistency' => false,
        'dobConsistency' => false,
    ...
    protected static $attributeMap = [
        ...
        'voiceChallengeCheck' => 'voiceChallengeCheck',
        'actionChallengeCheck' => 'actionChallengeCheck',
        'firstNameConsistency' => 'firstNameConsistency',
        'lastNameConsistency' => 'lastNameConsistency',
    ...
    protected static $setters = [
        ...
        'voiceChallengeCheck' => 'setVoiceChallengeCheck',
        'actionChallengeCheck' => 'setActionChallengeCheck',
        'firstNameConsistency' => 'setFirstNameConsistency',
        'lastNameConsistency' => 'setLastNameConsistency',
        'dobConsistency' => 'setDobConsistency',
    ...
    protected static $getters = [
        ...
        'voiceChallengeCheck' => 'getVoiceChallengeCheck',
        'actionChallengeCheck' => 'getActionChallengeCheck',
        'firstNameConsistency' => 'getFirstNameConsistency',
        'lastNameConsistency' => 'getLastNameConsistency',
        'dobConsistency' => 'getDobConsistency',
    ...
    public const VOICE_CHALLENGE_CHECK_PASSED = 'passed';
    public const VOICE_CHALLENGE_CHECK_FAILED = 'failed';
    public const VOICE_CHALLENGE_CHECK_NOT_PROCESSED = 'not_processed';
    public const ACTION_CHALLENGE_CHECK_PASSED = 'passed';
    public const ACTION_CHALLENGE_CHECK_FAILED = 'failed';
    public const ACTION_CHALLENGE_CHECK_NOT_PROCESSED = 'not_processed';
    public const FIRST_NAME_CONSISTENCY_PASSED = 'passed';
    public const FIRST_NAME_CONSISTENCY_FAILED = 'failed';
    public const FIRST_NAME_CONSISTENCY_NOT_PROCESSED = 'not_processed';
    public const LAST_NAME_CONSISTENCY_PASSED = 'passed';
    public const LAST_NAME_CONSISTENCY_FAILED = 'failed';
    public const LAST_NAME_CONSISTENCY_NOT_PROCESSED = 'not_processed';
    public const DOB_CONSISTENCY_PASSED = 'passed';
    public const DOB_CONSISTENCY_FAILED = 'failed';
    public const DOB_CONSISTENCY_NOT_PROCESSED = 'not_processed';
    public const DOCUMENT_NUMBER_CONSISTENCY_PASSED = 'passed';
    public const DOCUMENT_NUMBER_CONSISTENCY_FAILED = 'failed';
    public const DOCUMENT_NUMBER_CONSISTENCY_NOT_PROCESSED = 'not_processed';
    public const ISSUING_DATE_CONSISTENCY_PASSED = 'passed';
    public const ISSUING_DATE_CONSISTENCY_FAILED = 'failed';
    public const ISSUING_DATE_CONSISTENCY_NOT_PROCESSED = 'not_processed';
    public const EXPIRATION_DATE_CONSISTENCY_PASSED = 'passed';
    public const EXPIRATION_DATE_CONSISTENCY_FAILED = 'failed';
    public const EXPIRATION_DATE_CONSISTENCY_NOT_PROCESSED = 'not_processed';
     ...
     * @return string[]
     */
    public function getVoiceChallengeCheckAllowableValues()
    {
        return [
            self::VOICE_CHALLENGE_CHECK_PASSED,
            self::VOICE_CHALLENGE_CHECK_FAILED,
            self::VOICE_CHALLENGE_CHECK_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getActionChallengeCheckAllowableValues()
    {
        return [
            self::ACTION_CHALLENGE_CHECK_PASSED,
            self::ACTION_CHALLENGE_CHECK_FAILED,
            self::ACTION_CHALLENGE_CHECK_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getFirstNameConsistencyAllowableValues()
    {
        return [
            self::FIRST_NAME_CONSISTENCY_PASSED,
            self::FIRST_NAME_CONSISTENCY_FAILED,
            self::FIRST_NAME_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getLastNameConsistencyAllowableValues()
    {
        return [
            self::LAST_NAME_CONSISTENCY_PASSED,
            self::LAST_NAME_CONSISTENCY_FAILED,
            self::LAST_NAME_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getDobConsistencyAllowableValues()
    {
        return [
            self::DOB_CONSISTENCY_PASSED,
            self::DOB_CONSISTENCY_FAILED,
            self::DOB_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getDocumentNumberConsistencyAllowableValues()
    {
        return [
            self::DOCUMENT_NUMBER_CONSISTENCY_PASSED,
            self::DOCUMENT_NUMBER_CONSISTENCY_FAILED,
            self::DOCUMENT_NUMBER_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getIssuingDateConsistencyAllowableValues()
    {
        return [
            self::ISSUING_DATE_CONSISTENCY_PASSED,
            self::ISSUING_DATE_CONSISTENCY_FAILED,
            self::ISSUING_DATE_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getExpirationDateConsistencyAllowableValues()
    {
        return [
            self::EXPIRATION_DATE_CONSISTENCY_PASSED,
            self::EXPIRATION_DATE_CONSISTENCY_FAILED,
            self::EXPIRATION_DATE_CONSISTENCY_NOT_PROCESSED,
        ];
    }
     ...
     * @return string[]
     */
    public function getKnownFacesCheckAllowableValues()
    {
        return [
            self::KNOWN_FACES_CHECK_PASSED,
            self::KNOWN_FACES_CHECK_FAILED,
            self::KNOWN_FACES_CHECK_NOT_PROCESSED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('voiceChallengeCheck', $data ?? [], null);
        $this->setIfExists('actionChallengeCheck', $data ?? [], null);
        $this->setIfExists('firstNameConsistency', $data ?? [], null);
        $this->setIfExists('lastNameConsistency', $data ?? [], null);
        $this->setIfExists('dobConsistency', $data ?? [], null);
        $this->setIfExists('documentNumberConsistency', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getVoiceChallengeCheckAllowableValues();
        if (!is_null($this->container['voiceChallengeCheck']) && !in_array($this->container['voiceChallengeCheck'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'voiceChallengeCheck', must be one of '%s'",
                $this->container['voiceChallengeCheck'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getActionChallengeCheckAllowableValues();
        if (!is_null($this->container['actionChallengeCheck']) && !in_array($this->container['actionChallengeCheck'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'actionChallengeCheck', must be one of '%s'",
                $this->container['actionChallengeCheck'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getFirstNameConsistencyAllowableValues();
        if (!is_null($this->container['firstNameConsistency']) && !in_array($this->container['firstNameConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'firstNameConsistency', must be one of '%s'",
                $this->container['firstNameConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getLastNameConsistencyAllowableValues();
        if (!is_null($this->container['lastNameConsistency']) && !in_array($this->container['lastNameConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'lastNameConsistency', must be one of '%s'",
                $this->container['lastNameConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getDobConsistencyAllowableValues();
        if (!is_null($this->container['dobConsistency']) && !in_array($this->container['dobConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'dobConsistency', must be one of '%s'",
                $this->container['dobConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getDocumentNumberConsistencyAllowableValues();
        if (!is_null($this->container['documentNumberConsistency']) && !in_array($this->container['documentNumberConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'documentNumberConsistency', must be one of '%s'",
                $this->container['documentNumberConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getIssuingDateConsistencyAllowableValues();
        if (!is_null($this->container['issuingDateConsistency']) && !in_array($this->container['issuingDateConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'issuingDateConsistency', must be one of '%s'",
                $this->container['issuingDateConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getExpirationDateConsistencyAllowableValues();
        if (!is_null($this->container['expirationDateConsistency']) && !in_array($this->container['expirationDateConsistency'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'expirationDateConsistency', must be one of '%s'",
                $this->container['expirationDateConsistency'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getKnownFacesCheckAllowableValues();
        if (!is_null($this->container['knownFacesCheck']) && !in_array($this->container['knownFacesCheck'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    /**
     * Gets voiceChallengeCheck
     *
     * @return string|null
     */
    public function getVoiceChallengeCheck()
    {
        return $this->container['voiceChallengeCheck'];
    }

    /**
     * Sets voiceChallengeCheck
     *
     * @param string|null $voiceChallengeCheck Indicates if the enduser had answered correctly during the voice challenge
     *
     * @return self
     */
    public function setVoiceChallengeCheck($voiceChallengeCheck)
    {
        if (is_null($voiceChallengeCheck)) {
            throw new \InvalidArgumentException('non-nullable voiceChallengeCheck cannot be null');
        }
        $allowedValues = $this->getVoiceChallengeCheckAllowableValues();
        if (!in_array($voiceChallengeCheck, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'voiceChallengeCheck', must be one of '%s'",
                    $voiceChallengeCheck,
        ...
        $this->container['voiceChallengeCheck'] = $voiceChallengeCheck;

        return $this;
    }

    /**
     * Gets actionChallengeCheck
     *
     * @return string|null
     */
    public function getActionChallengeCheck()
    {
        return $this->container['actionChallengeCheck'];
    }

    /**
     * Sets actionChallengeCheck
     *
     * @param string|null $actionChallengeCheck Indicates if the enduser had moved correctly during the actions challenge
     *
     * @return self
     */
    public function setActionChallengeCheck($actionChallengeCheck)
    {
        if (is_null($actionChallengeCheck)) {
            throw new \InvalidArgumentException('non-nullable actionChallengeCheck cannot be null');
        }
        $allowedValues = $this->getActionChallengeCheckAllowableValues();
        if (!in_array($actionChallengeCheck, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'actionChallengeCheck', must be one of '%s'",
                    $actionChallengeCheck,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['actionChallengeCheck'] = $actionChallengeCheck;

        return $this;
    }

    /**
     * Gets firstNameConsistency
     *
     * @return string|null
     */
    public function getFirstNameConsistency()
    {
        return $this->container['firstNameConsistency'];
    }

    /**
     * Sets firstNameConsistency
     *
     * @param string|null $firstNameConsistency Indicates if the first name on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setFirstNameConsistency($firstNameConsistency)
    {
        if (is_null($firstNameConsistency)) {
            throw new \InvalidArgumentException('non-nullable firstNameConsistency cannot be null');
        }
        $allowedValues = $this->getFirstNameConsistencyAllowableValues();
        if (!in_array($firstNameConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'firstNameConsistency', must be one of '%s'",
                    $firstNameConsistency,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['firstNameConsistency'] = $firstNameConsistency;

        return $this;
    }

    /**
     * Gets lastNameConsistency
     *
     * @return string|null
     */
    public function getLastNameConsistency()
    {
        return $this->container['lastNameConsistency'];
    }

    /**
     * Sets lastNameConsistency
     *
     * @param string|null $lastNameConsistency Indicates if the last name on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setLastNameConsistency($lastNameConsistency)
    {
        if (is_null($lastNameConsistency)) {
            throw new \InvalidArgumentException('non-nullable lastNameConsistency cannot be null');
        }
        $allowedValues = $this->getLastNameConsistencyAllowableValues();
        if (!in_array($lastNameConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'lastNameConsistency', must be one of '%s'",
                    $lastNameConsistency,
        ...
        $this->container['lastNameConsistency'] = $lastNameConsistency;
     ...
     * @return string|null
     */
    public function getDobConsistency()
    {
        return $this->container['dobConsistency'];
    }

    /**
     * Sets dobConsistency
     *
     * @param string|null $dobConsistency Indicates if the date of birth on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setDobConsistency($dobConsistency)
    {
        if (is_null($dobConsistency)) {
            throw new \InvalidArgumentException('non-nullable dobConsistency cannot be null');
        }
        $allowedValues = $this->getDobConsistencyAllowableValues();
        if (!in_array($dobConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'dobConsistency', must be one of '%s'",
                    $dobConsistency,
        ...
        $this->container['dobConsistency'] = $dobConsistency;

        return $this;
    }

    /**
     * Gets documentNumberConsistency
     *
     * @return string|null
     */
    public function getDocumentNumberConsistency()
    {
        return $this->container['documentNumberConsistency'];
    }

    /**
     * Sets documentNumberConsistency
     *
     * @param string|null $documentNumberConsistency Indicates if the document number on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setDocumentNumberConsistency($documentNumberConsistency)
    {
        if (is_null($documentNumberConsistency)) {
            throw new \InvalidArgumentException('non-nullable documentNumberConsistency cannot be null');
        }
        $allowedValues = $this->getDocumentNumberConsistencyAllowableValues();
        if (!in_array($documentNumberConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'documentNumberConsistency', must be one of '%s'",
                    $documentNumberConsistency,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['documentNumberConsistency'] = $documentNumberConsistency;

        return $this;
    }

    /**
     * Gets issuingDateConsistency
     *
     * @return string|null
     */
    public function getIssuingDateConsistency()
    {
        return $this->container['issuingDateConsistency'];
    }

    /**
     * Sets issuingDateConsistency
     *
     * @param string|null $issuingDateConsistency Indicates if the issuing date on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setIssuingDateConsistency($issuingDateConsistency)
    {
        if (is_null($issuingDateConsistency)) {
            throw new \InvalidArgumentException('non-nullable issuingDateConsistency cannot be null');
        }
        $allowedValues = $this->getIssuingDateConsistencyAllowableValues();
        if (!in_array($issuingDateConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'issuingDateConsistency', must be one of '%s'",
                    $issuingDateConsistency,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['issuingDateConsistency'] = $issuingDateConsistency;

        return $this;
    }

    /**
     * Gets expirationDateConsistency
     *
     * @return string|null
     */
    public function getExpirationDateConsistency()
    {
        return $this->container['expirationDateConsistency'];
    }

    /**
     * Sets expirationDateConsistency
     *
     * @param string|null $expirationDateConsistency Indicates if the expiration date on the document and the MRZ are consistent
     *
     * @return self
     */
    public function setExpirationDateConsistency($expirationDateConsistency)
    {
        if (is_null($expirationDateConsistency)) {
            throw new \InvalidArgumentException('non-nullable expirationDateConsistency cannot be null');
        }
        $allowedValues = $this->getExpirationDateConsistencyAllowableValues();
        if (!in_array($expirationDateConsistency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'expirationDateConsistency', must be one of '%s'",
                    $expirationDateConsistency,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['expirationDateConsistency'] = $expirationDateConsistency;

        return $this;
    }

    /**
     * Gets knownFacesCheck
     *
     * @return string|null
     */
    public function getKnownFacesCheck()
    {
        return $this->container['knownFacesCheck'];
    }

    /**
     * Sets knownFacesCheck
     *
     * @param string|null $knownFacesCheck Indicates if the selfie image matches an aready existing client/customer
     *
     * @return self
     */
    public function setKnownFacesCheck($knownFacesCheck)
    {
        if (is_null($knownFacesCheck)) {
            throw new \InvalidArgumentException('non-nullable knownFacesCheck cannot be null');
        }
        $allowedValues = $this->getKnownFacesCheckAllowableValues();
        if (!in_array($knownFacesCheck, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'knownFacesCheck', must be one of '%s'",
                    $knownFacesCheck,
