...
class CheckResultDetectionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets attributes
     *
     * @param \Irisnet\API\Client\Model\Attribute[]|null $attributes Attributes characterizing the text.
     *
     * @return self
     */
     ...
     * Sets subDetections
     *
     * @param \Irisnet\API\Client\Model\BaseDetection[]|null $subDetections A set of sub-detection for text moderation.
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string|null $content The text that was detected
     *
     * @return self
     */
