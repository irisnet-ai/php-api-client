...
/**
 * ImageAnalysisDetection Class Doc Comment
 *
 * @category Class
 * @description Contains further characteristics of the image itself.
 * @package  Irisnet\API\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ImageAnalysisDetection extends Detection
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageAnalysisDetection';
    ...
    */
     ...
     * Sets attributes
     *
     * @param \Irisnet\API\Client\Model\Attribute[]|null $attributes Attributes characterizing the _image_ detection.
     *
     * @return self
     */
