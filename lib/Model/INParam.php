 ...
 */
class INParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['inClass'] = $data['inClass'] ?? null;
        $this->container['min'] = $data['min'] ?? null;
        $this->container['max'] = $data['max'] ?? null;
        $this->container['severity'] = $data['severity'] ?? 100;
        $this->container['drawMode'] = $data['drawMode'] ?? null;
        $this->container['grey'] = $data['grey'] ?? 127;
        $this->container['scale'] = $data['scale'] ?? 1.0;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inClass']) && !in_array($this->container['inClass'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'inClass', must be one of '%s'",
                $this->container['inClass'],
